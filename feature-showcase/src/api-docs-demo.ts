...
app.route({
  ...
  handler: (req, res) => {
    ...
    const results = users.filter(user => {
      ...
      return exact ? field === q : field.toLowerCase().includes(q.toLowerCase());
    });
...
app.enableDocs({
  ...
  version: '1.0.0',
  description:
    'Comprehensive API documentation automatically generated from Zod schemas and intelligent routes',
  basePath: '/docs',
  servers: [
